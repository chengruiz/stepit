...
function(stepit_load_plugin_index plugin_root output_var)
  set(STEPIT_PLUGIN_PATHS "__STEPIT_PLUGIN_PATHS_UNSET__")
  include("${plugin_root}/plugins.cmake")
  if ("${STEPIT_PLUGIN_PATHS}" STREQUAL "__STEPIT_PLUGIN_PATHS_UNSET__")
    message(FATAL_ERROR "Plugin index '${plugin_root}/plugins.cmake' must set STEPIT_PLUGIN_PATHS.")
  endif ()
  set(${output_var} "${STEPIT_PLUGIN_PATHS}" PARENT_SCOPE)
endfunction()
