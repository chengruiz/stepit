#ifndef STEPIT_MODULAR_POLICY_LOCOMOTION_CMD_VEL_SOURCE_H_
#define STEPIT_MODULAR_POLICY_LOCOMOTION_CMD_VEL_SOURCE_H_
...
class CmdVelSource : public Module {
 public:
  CmdVelSource(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec);
  bool reset() override;
...
#endif  // STEPIT_MODULAR_POLICY_LOCOMOTION_CMD_VEL_SOURCE_H_
