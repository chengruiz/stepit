#include <stepit/modular_policy/locomotion/odometry_source.h>

namespace stepit {
namespace modular_policy {
DummyOdometrySource::DummyOdometrySource(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
