...
#include <stepit/modular_policy_locomotion_ros2/cmd_posture_subscriber2.h>
#include <stepit/ros2/node.h>

namespace stepit::modular_policy {
CmdRollSubscriber2::CmdRollSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
...
CmdPitchSubscriber2::CmdPitchSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
...
CmdHeightSubscriber2::CmdHeightSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
