...
#include <stepit/modular_policy_locomotion_ros2/cmd_vel_subscriber2.h>
#include <stepit/ros2/node.h>

namespace stepit::modular_policy {
CmdVelSubscriber2::CmdVelSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
    : CmdVelSource(policy_spec, ModuleSpec(module_spec, "cmd_vel")) {
