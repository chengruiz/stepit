...
#include <stepit/modular_policy_locomotion_ros2/heightmap_subscriber2.h>
...
HeightmapSubscriber2::HeightmapSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
...
void HeightmapSubscriber2::postStep(const FieldMap &) {
