#ifndef STEPIT_MODULAR_POLICY_LOCOMOTION_ROS2_HEIGHTMAP_SUBSCRIBER2_H_
#define STEPIT_MODULAR_POLICY_LOCOMOTION_ROS2_HEIGHTMAP_SUBSCRIBER2_H_
...
#include <stepit/modular_policy/locomotion/heightmap_source.h>
#include <stepit/ros2/node.h>

namespace stepit::modular_policy {
class HeightmapSubscriber2 : public DummyHeightmapSource {
 public:
  HeightmapSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec);
  bool reset() override;
...
#endif  // STEPIT_MODULAR_POLICY_LOCOMOTION_ROS2_HEIGHTMAP_SUBSCRIBER2_H_
