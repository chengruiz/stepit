#ifndef STEPIT_MODULAR_POLICY_LOCOMOTION_ROS2_CMD_POSTURE_SUBSCRIBER2_H_
#define STEPIT_MODULAR_POLICY_LOCOMOTION_ROS2_CMD_POSTURE_SUBSCRIBER2_H_
...
class CmdRollSubscriber2 : public CmdRollSource {
 public:
  CmdRollSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec);
  bool reset() override;
...
class CmdPitchSubscriber2 : public CmdPitchSource {
 public:
  CmdPitchSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec);
  bool reset() override;
  bool update(const LowState &low_state, ControlRequests &requests, FieldMap &context) override;
  void exit() override;
...
class CmdHeightSubscriber2 : public CmdHeightSource {
 public:
  CmdHeightSubscriber2(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec);
  bool reset() override;
  bool update(const LowState &low_state, ControlRequests &requests, FieldMap &context) override;
  void exit() override;
...
#endif  // STEPIT_MODULAR_POLICY_LOCOMOTION_ROS2_CMD_POSTURE_SUBSCRIBER2_H_
