#ifndef STEPIT_MODULAR_POLICY_ROS_FIELD_SUBSCRIBER_H_
#define STEPIT_MODULAR_POLICY_ROS_FIELD_SUBSCRIBER_H_
...
class FieldSubscriber : public Module {
 public:
  FieldSubscriber(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec);
  bool reset() override;
...
#endif  // STEPIT_MODULAR_POLICY_ROS_FIELD_SUBSCRIBER_H_
