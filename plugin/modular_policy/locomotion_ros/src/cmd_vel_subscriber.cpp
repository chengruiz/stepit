...
#include <stepit/modular_policy_locomotion_ros/cmd_vel_subscriber.h>

namespace stepit {
namespace modular_policy {
CmdVelSubscriber::CmdVelSubscriber(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
