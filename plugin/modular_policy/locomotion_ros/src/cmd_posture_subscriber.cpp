...
#include <stepit/modular_policy_locomotion_ros/cmd_posture_subscriber.h>

namespace stepit {
namespace modular_policy {
CmdRollSubscriber::CmdRollSubscriber(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
...
CmdPitchSubscriber::CmdPitchSubscriber(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
...
CmdHeightSubscriber::CmdHeightSubscriber(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
