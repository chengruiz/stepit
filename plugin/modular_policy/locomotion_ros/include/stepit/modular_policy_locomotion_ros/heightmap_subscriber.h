#ifndef STEPIT_MODULAR_POLICY_LOCOMOTION_ROS_HEIGHTMAP_SUBSCRIBER_H_
#define STEPIT_MODULAR_POLICY_LOCOMOTION_ROS_HEIGHTMAP_SUBSCRIBER_H_
...
class HeightmapSubscriber : public DummyHeightmapSource {
 public:
  HeightmapSubscriber(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec);
  bool reset() override;
...
#endif  // STEPIT_MODULAR_POLICY_LOCOMOTION_ROS_HEIGHTMAP_SUBSCRIBER_H_
