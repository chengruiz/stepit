#include <stepit/modular_policy_redis/field_subscriber.h>
...
RedisFieldSubscriber::RedisFieldSubscriber(const ModularPolicySpec &policy_spec, const ModuleSpec &module_spec)
